...
class RadialMenu {
  ...
  constructor (id, titles) {
    ...
    this.pathContracted   = {fill: '#ffffff', 'stroke-width': 3, stroke: '#ffffff'};
    ...
    // Sets the parameters for the wheel. According to the defaults or user set parameters
   ...
   * @author Nathan Leadill
   * @memberof RadialMenu
   * @description Sets the parameters for the radial menu, if you wish to change something, check the docs. It's all customisable via the instance.property = value
   */
  loadParameters () {
    // DO NOT MODIFY
   ...
   * @author Nathan Leadill
   * @memberof RadialMenu
   * @description Sets up the click handler for each slice, you can listen to this by calling instance.onClicked = function(index){...}. Index is the index number of the radial menu.
   */
  setupWheel () {
    ...
    for(let i =0; i < numberOfItems; i++)
    {
      this.wheel.navItems[i].navigateFunction =  (e) => {
        console.debug("Slice " + i + " has been clicked.");
        this.onClicked(i);
      };
    }
  }
   ...
   * @author Nathan Leadill
   * @memberof RadialMenu
   * @description No default logic, needs to be extended via the instance.onClicked = function(index){...}
   * @param {Integer} index Index number of the slice that was clicked.
   */
  onClicked (index) {
  }
